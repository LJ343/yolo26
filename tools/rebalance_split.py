...
def greedy_stratified_split(frames, train_ratio=0.85):
    """
    核心算法：多标签贪婪均衡切分
    确保极度不平衡的类别也能在 train 和 val 中按比例存在。
    """
...
def main():
    ...
    parser.add_argument('--source_dir', type=str, required=True, help='需重新切分的原始数据集根目录 (如: /home/jzyh/xbzl/traffic_light/data_v1_filtered)')
    parser.add_argument('--output_dir', type=str, required=True, help='重组后的完美比例数据集输出目录 (如: /home/jzyh/xbzl/traffic_light/data_v1_rebalanced)')
